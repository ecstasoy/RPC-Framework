 ...
 *
 * <p>Consistent hash algorithm is used to select the instance of the service.
 * <p>It uses a hash ring to distribute the load to the instances.
 * <p>It uses virtual nodes to balance the load.
 *
 * @see LoadBalancer
...
public class ConsistentHashLoadBalancer implements LoadBalancer {
  ...
  /**
   * Instantiates a new Consistent hash load balancer.
   */
