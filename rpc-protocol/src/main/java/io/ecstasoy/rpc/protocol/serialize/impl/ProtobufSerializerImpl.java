package io.ecstasoy.rpc.protocol.serialize.impl;

import com.alibaba.fastjson.JSON;
import com.google.protobuf.ByteString;
import io.netty.util.concurrent.FastThreadLocal;
import lombok.extern.slf4j.Slf4j;
import io.ecstasoy.rpc.core.protocol.proto.RpcRequestProto;
import io.ecstasoy.rpc.core.protocol.proto.RpcResponseProto;
import io.ecstasoy.rpc.core.protocol.proto.ThrowableProto;
...
public class ProtobufSerializerImpl implements Serializer {
  ...
  private RpcResponse deserializeResponse(byte[] bytes) throws Exception {
    ...
    if (proto.hasThrowable()) {
      ...
      throwableProto.getMessage();
      String message = throwableProto.getMessage();
