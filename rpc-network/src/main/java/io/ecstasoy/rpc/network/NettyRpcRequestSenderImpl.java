...
import io.ecstasoy.rpc.interceptor.ClientInterceptorChainManager;
...
import io.ecstasoy.rpc.transport.client.RequestFutureManager;
...
public class NettyRpcRequestSenderImpl implements RpcRequestSender {
  ...
  private final ChannelPool channelPool = new ChannelPool(300);
